...
<img src="img/ch16_drawing.png" width="300">
...
<img src="img/ch16_structure.png" width="400">
...
[src/CompositeTemplate.java](src/CompositeTemplate.java)
...
(見 [src/GUIWidgetComposite.java](src/GUIWidgetComposite.java) 中的 `WindowV1` 類別)
...
(見 [src/GUIWidgetComposite.java](src/GUIWidgetComposite.java) 中的 `WindowV2` 類別)
...
[src/ContainerCompositeExample.java](src/ContainerCompositeExample.java)
...
[src/JTreeCompositeExample.java](src/JTreeCompositeExample.java)
